...
test: test.cpp test.h test-chrono-chat.cpp test-chrono-chat.h test-conference-discovery-sync.cpp test-conference-discovery-sync.h chatbuf.pb.cc
	g++ -Wall -ggdb test.cpp test-chrono-chat.cpp test-conference-discovery-sync.cpp chatbuf.pb.cc -lndn-cpp -lpthread -lcrypto -lprotobuf -o test
chat-library: test-chrono-chat.cpp test-chrono-chat.h chatbuf.pb.cc
	g++ -c -Wall -ggdb test-chrono-chat.cpp chatbuf.pb.cc -lndn-cpp -lpthread -lcrypto -lprotobuf
...
conference-discovery-library: test-conference-discovery-sync.cpp
	g++ -c -Wall -ggdb test-conference-discovery-sync.cpp -lndn-cpp -lpthread -lcrypto
